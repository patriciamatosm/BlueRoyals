...
public class Subscriptions extends VerticalLayout {
    ...
    private Div createEventCard(Event event) {
        ...
        unsubscribeButton.getStyle().set("margin-left", "auto");
        unsubscribeButton.getStyle().set("background-color", "red");
        unsubscribeButton.getStyle().set("color", "white");
        ...
        eventInfoLayout.add(eventName, eventDesc, eventCreateUser, eventDate, eventLocation, maxUser, unsubscribeButton);
